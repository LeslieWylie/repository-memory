...
| --- | --- | --- |
| Repository Memory release | `0.7.15` | The Python project, standalone SQLite/vector L0-L3 runtime, Git-backed team-memory sync, MemOS-inspired episode/feedback/policy lifecycle, MMR/recency local recall, explicit observe/reflect operations, citation-first index, installer, MCP server, native OpenClaw lifecycle/tools, provider contract, supervisor, benchmark runner and AML Add/Search wrapper. |
