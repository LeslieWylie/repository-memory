...
| --- | --- | --- |
| Repository Memory release | `0.7.12` | The Python project, standalone SQLite/vector L0-L3 runtime, MemOS-inspired episode/feedback/policy lifecycle, citation-first index, installer, MCP server, native OpenClaw lifecycle/tools, provider contract, supervisor, benchmark runner and AML Add/Search wrapper. |
