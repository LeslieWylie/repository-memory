...
| --- | --- | --- |
| Repository Memory release | `0.4.0` | The Python project, standalone SQLite L0-L3 runtime, citation-first index, installer, MCP server, OpenClaw plugin, and optional vendored compatibility components. |
